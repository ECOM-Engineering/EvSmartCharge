...
defaultSettings = {'manual':{'currentSet': 12, 'chargeLimit': 80, '3_phases': False, 'phaseSet': True},
                   'pv': {'max_1_Ph_current': 14, 'min_3_Ph_current': 8, 'chargeLimit': 80, '3_phases': False}}

def writeSettings(file = "", settingsDict = {}):
...
#writeSettings("./PV_Manager.json", manualSettings)
#settingsRead = readSettings("./PV_Manager.json")
